        ...
        <div className="min-h-[70vh] flex flex-col items-center justify-center p-4">
            <div className="bg-white p-6 sm:p-8 md:p-10 rounded-xl sm:rounded-3xl shadow-xl sm:shadow-2xl max-w-md w-full text-center border-t-8 border-red-500 transform transition-all hover:-translate-y-1">
                ...
                <div className="space-y-3 sm:space-y-4">
                    <NavLink to="/" className="block w-full bg-red-500 hover:bg-red-600 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-xl transition shadow-lg hover:shadow-xl text-sm sm:text-base">
                        Return to Events
                    </NavLink>
                    <NavLink to="/dashboard" className="block w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-xl transition text-sm sm:text-base">
                        Go to Dashboard
                    </NavLink>
                </div>
            </div>
